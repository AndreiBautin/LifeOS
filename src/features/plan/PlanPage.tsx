      ...
      <Section title="How the week is shaped">
        <Card>
          <div className="mb-2 flex items-center justify-between gap-2">
            <span className="text-ink-300 text-sm">Priority spread</span>
            <Badge
              tone={
                plan.spreadLabel === 'focused'
                  ? 'good'
                  : plan.spreadLabel === 'moderate'
                    ? 'warn'
                    : 'bad'
              }
            >
          ...
          <p className="text-ink-500 text-sm">{plan.spreadReason}</p>

          <div className="border-ink-800 mt-3 flex items-baseline justify-between border-t pt-3">
            <span className="text-ink-300 text-sm">Hard sets a week, all muscles</span>
            <span className="numeric text-ink-50 text-lg font-semibold">
              {plan.totalWeeklySets}
            </span>
          </div>
        </Card>
      </Section>
      ...
      <Section title="Change any of it">
        <Card className="space-y-3">
          <p className="text-ink-300 text-sm">
            ...
            for that muscle, and how many muscles share the top tier. All three are in Settings.
          </p>
